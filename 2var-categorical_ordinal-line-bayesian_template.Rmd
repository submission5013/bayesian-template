...
### Check priors
Next, you'll want to check your priors by running this code chunk. It will produce a set of 100 sample plots drawn from the priors you set in the previous section, so you can check to see if the values generated are reasonable. (We'll go into the details of this code later.) 
